    ...
    >
      <div>
        ...
        <form className="sm:mt-14 mt-7 sm:space-y-9 space-y-5">
          <input
            className="w-full h-14 px-4 bg-[#262036] border border-primary [box-shadow:0px_4px_20px_#8B68FF25] rounded-lg"
          ...
          <textarea
            rows={4}
            className="bg-[#262036] w-full text-[#898686] p-4 border border-primary [box-shadow:0px_4px_20px_#8B68FF25] rounded-lg"
          >
