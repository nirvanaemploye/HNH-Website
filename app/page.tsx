    ...
    <div className="container max-w-[1320px] space-y-32">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <span className="uppercase text-primary text-xl border-b-2 border-dashed border-white pb-1 w-fit md:text-start text-center">
            who we are
          </span>
      ...
      <section id="servicesSection">
        <div className="servicesContainer">
          <div className="servicesHeading">
            ...
            <h1 className="font-serif font-bold text-[40px]">
              HIT-N-HAMMER SERVICES
            </h1>
      ...
      <div className="relative z-10">
        <h3 className="font-serif text-primary font-bold text-2xl md:text-5xl text-center border-b-2 border-dashed border-white uppercase w-fit mx-auto">
          methodology
        </h3>
      ...
      <div>
        <p className="text-primary text-2xl font-medium capitalize text-center border-b-2 border-dashed w-fit mx-auto">
          hire us
        </p>
        ...
        <div className="mt-10 grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4">
          {developers.map((develoer, idx) => {
            return (
              <div
                key={idx}
                className="border-2 bg-[#241653] border-primary rounded-tl-3xl rounded-br-3xl px-8 py-4"
              >
                <Image
                  className="mx-auto"
                  src={develoer.image}
      ...
      <div>
        ...
        <h3 className="uppercase font-serif text-white font-bold sm:text-4xl text-3xl text-center mt-4">
          the hit-n-hammer
        </h3>
